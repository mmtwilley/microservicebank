package com.msbanks.accounts.controller;


import com.msbanks.accounts.constants.AccountsConstants;
import com.msbanks.accounts.dto.AccountsContactInfoDto;
...
public class AccountsController {
    ...
    public ResponseEntity<CustomerDto> fetchAccountDetails(@RequestParam @Pattern(regexp="(^$|[0-9]{10})",
        ...
        CustomerDto customerDto = iAccountsServices.fetchAccount(mobileNumber);
    ...
    @Operation(
            ...
            description = "Get Java version that is installed into accounts microsevice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Contact Info details that can be reached our in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
